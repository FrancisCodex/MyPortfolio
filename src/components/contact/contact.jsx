      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="p-6 mr-2 sm:rounded-lg">
          ...
          <div className="flex items-center mt-8">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" className="w-8 h-8 text-green-700">
          ...
          <div className="flex items-center mt-2">
            ...
            <div className="ml-4 text-md tracking-wide font-semibold w-40">
              francisadrian.altesing@gmail.com
            </div>
          </div>
        </div>
        <form className="p-6 flex flex-col justify-center">
          ...
          <button type="submit" className="md:w-32 bg-primary hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-green-700 transition ease-in-out duration-300">
            Submit
          </button>
        </form>
      </div>
